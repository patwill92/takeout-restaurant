...
export const invalidInput = (index,clientMenu,menuItemInQuestion)=>{
  return (dispatch,getState)=>{
    const newMenu = [...clientMenu];
      newMenu[index] = {...menuItemInQuestion,specialMessage:true,specialMessageValue:"please fill out all fields"}
...
export const postReview = (itmInQuest,id,index,menu)=> (dispatch,getState) =>{
   const newMenu = [...menu];
    newMenu[index] = {...newMenu[index],currentReview:'',
              showInput:false,
              specialMessage:true,
              starAmount:0,
