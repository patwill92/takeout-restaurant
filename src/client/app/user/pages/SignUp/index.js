...
const styles = theme => ({
    ...
    registerMessage: {
        backgroundImage: 'url("http://cdn-image.foodandwine.com/sites/default/files/styles/medium_2x/public/2012-cocktails-xl-umami-burgers-with-port-and-stilton.jpg?itok=iiKxK4bs") !important',
                ...
                <Grid.Column className={classes.column} mobile={16} tablet={16} computer={15}>
                    <Container style={{padding: '40px 35px', backgroundColor: '#fff'}}>
                        <div className={classes.message}>
                            ...
                            <h1 style={{fontWeight: 300}}>The best forking burgers, period.</h1>
                        </div>
                        <SignupForm/>
                    </Container>
                    <div className={classes.registerMessage}>
                        <div className={classes.imgOverlay}>
                            <div>
                                <h1 style={{textAlign: 'center', letterSpacing: '1px', marginBottom: 10}}>One of
                                    us?</h1>
