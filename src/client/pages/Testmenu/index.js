        ...
        return (
            <div style={{margin: 0, width: '100%', display: 'flex', justifyContent: 'center'}}>
                {menu.testMenu && menu.testMenu.map(item => {
                    ...
                    return (
                        <Card key='menu' style={{padding: 20, display: 'flex', justifyContent: 'center', flexDirection: 'column'}} color='red'>
                            ...
                            <div>
                                {
                                    item.reviews.map((review, i) => {
                                        return (
                                            <div style={{marginBottom: 10, marginTop: 10, border: '1px solid blue', padding:10}} key={i}>
